...
namespace Submarine
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			//Console.WriteLine("Day 6, part 1: " + Day6.Solution.Part1());
			////Console.WriteLine("Day 6, part 2: " + Day6.Solution.Part2());
			//Console.WriteLine("Day 6, part 2: " + "A lot");
			//Console.WriteLine();

			//Console.WriteLine("Day 7, part 1: " + Day7.Solution.Part1());
			//Console.WriteLine("Day 7, part 2: " + Day7.Solution.Part2());
			//Console.WriteLine();

			//Console.WriteLine("Day 8, part 1: " + Day8.Solution.Part1());
			...
			//Console.WriteLine("Day 16, part 1: " + Day16.Solution.Part1());
			//Console.WriteLine("Day 16, part 2: " + Day16.Solution.Part2());
			//Console.WriteLine();

			//Console.WriteLine("Day 17, part 1: " + Day17.Solution.Part1());
			//Console.WriteLine("Day 17, part 2: " + Day17.Solution.Part2());
			//Console.WriteLine();

			//Console.WriteLine("Day 18, part 1: " + Day18.Solution.Part1());
			//Console.WriteLine("Day 18, part 2: " + Day18.Solution.Part2());
			//Console.WriteLine();

			//Console.WriteLine("Day 19, part 1: " + Day19.Solution.Part1());
			//Console.WriteLine("Day 19, part 2: " + Day19.Solution.Part2());
			//Console.WriteLine();

			//Console.WriteLine("Day 20, part 1: " + Day20.Solution.Part1());
			//Console.WriteLine("Day 20, part 2: " + Day20.Solution.Part2());
			//Console.WriteLine();

			Console.WriteLine("Day 21, part 1: " + Day21.Solution.Part1());
			Console.WriteLine("Day 21, part 2: " + Day21.Solution.Part2());
			Console.WriteLine();
